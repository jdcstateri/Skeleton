...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:Label ID="lblPostCode" runat="server" Text="Enter a Post Code" style="z-index: 1; left: 10px; top: 460px; position: absolute; right: 1358px;"></asp:Label>
            <asp:TextBox ID="txtPostCode" runat="server" style="z-index: 1; left: 152px; top: 458px; position: absolute"></asp:TextBox>
            ...
            <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 15px; top: 535px; position: absolute" ForeColor="Red"></asp:Label>
    </form>
</body>
</html>
